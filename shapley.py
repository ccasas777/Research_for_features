...
# Restore SSD model.
ckpt_filename = '/mnt/data-home/anderschen/lgeadas/checkpoint/VGG_VOC0712_SSD_300x300_iter_120000.ckpt'
...
img_path_root = './imgs'
img_name = 'dog.jpg'
img = mpimg.imread(os.path.join(img_path_root, img_name))

save_path = os.path.join(img_path_root, 'results')
